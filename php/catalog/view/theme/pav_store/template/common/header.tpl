		...
		<div class="mainnav-inner">
			<div class="row-fluid">
				...
				?>
						...
						<nav id="mainmenu" class="span8 offset3">	<?php echo $module; ?></nav>
						<?php } ?>

				<?php } elseif ($categories) { ?>
				<nav id="mainmenu" class="span8 offset3"><div class="navbar">
			...
			<div id="search" class="span1 hidden-tablet hidden-phone">
