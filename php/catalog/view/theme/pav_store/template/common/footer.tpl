...
<div class="footer-center">
		...
		<div class="column span2">
			<div class="box social">
				...
				<?php echo html_entity_decode( $themeConfig['widget_social_data'][$LANGUAGE_ID], ENT_QUOTES, 'UTF-8' ); ?>
		</div>
		</div>
		 <?php } ?>
...
<div id="powered">
	<div class="container">
		<div class="container-inner">
			...
			<?php } else { ?>
			<?php } ?>
				Charm House - Responsive & <a href="http://www.fastcomet.com/free-opencart-themes" title="Free OpenCart Themes">Free OpenCart Themes</a>. Designed by <a href="http://www.fastcomet.com/">FastComet</a>
			</div>
		</div>
		</div>
	</div>
