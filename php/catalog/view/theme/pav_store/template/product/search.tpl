    ...
    <div class="span<?php echo $span;?> product-block">
      ...
      <div class="description"><?php echo utf8_substr( strip_tags($product['description']),0,85);?>...</div>
	   ...
	   <div class="product-action">
		  <span class="wishlist-compare"><a class="wishlist" onclick="addToWishList('<?php echo $product['product_id']; ?>');" title="<?php echo $button_wishlist; ?>" ><?php echo $button_wishlist; ?></a>
		  <a  class="compare" onclick="addToCompare('<?php echo $product['product_id']; ?>');" title="<?php echo $button_compare; ?>" ><?php echo $button_compare; ?></a></span>
