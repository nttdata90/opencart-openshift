     ...
     <div class="addition-actions">
       <span class="cart-info product-extra">
         ...
         <!-- <span>&nbsp;&nbsp;<?php //echo $text_or; ?>&nbsp;&nbsp;</span> -->
          ...
          <span class="wishlist-compare pull-right">
    ...
    <div class="span<?php echo $span;?> product-block">
      ...
      <a href="<?php echo $product['href']; ?>"><img src="<?php echo $product['thumb']; ?>" title="<?php echo $product['name']; ?>" alt="<?php echo $product['name']; ?>" /></a>
		<?php if( $categoryPzoom ) { $zimage = str_replace( "cache/","", preg_replace("#-\d+x\d+#", "",  $product['thumb'] ));  ?>
          <a href="<?php echo $zimage;?>"  id="colorbox_<?php echo $product['product_id'];?>" class="product-zoom" title="<?php echo $product['name']; ?>"><span class="fa fa-search-plus"></span></a>
		<script type="text/javascript">
