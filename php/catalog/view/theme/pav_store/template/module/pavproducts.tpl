					...
					<div class="tab-content">  
										...
										<?php } ?>
											...
											<div class="product-meta">
												...
												<div class="description">
													<?php echo utf8_substr( strip_tags($product['description']),0,200);?>...
												</div>
					 ...
					 <div class="tab-nav">
							<ul class="h-tabs" id="producttabs<?php echo $id;?>">
								<?php $i=0; foreach( $tabs as $tab => $category ) { 
									if( empty($category) ){ continue;}
									$tab = 'cattabs';
								...
								?>
									 ...
									 <a href="#tab-<?php echo $tab.$id.$category['category_id'];?>" data-toggle="tab">
										...
										<i class="icon-th"></i>	
										<?php } ?>
										<span class="hidden-phone"><?php echo $category['category_name'];?></span>
									 </a>
									 </li>
								<?php } ?>
							</ul>
